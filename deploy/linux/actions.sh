...
declare -A install_reflector=(
    ...
    [arch2]="sudo reflector --country France,Germany,Greece,Switzerland --latest 5 --sort rate --age 6 --save /etc/pacman.d/mirrorlist"
...
declare -A install_libreoffice=(
    ...
    [arch]="sudo pacman -S --needed libreoffice-fresh hunspell hunspell-en_us hunspell-el"
)
